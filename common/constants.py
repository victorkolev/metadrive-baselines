...
CAMERAS = {
    0: dict(distance=2.1, lookat=[-0.4, 0.5, 2.0], azimuth=70, elevation=-37.5),
    1: dict(distance=2.2, lookat=[-0.2, 0.75, 2.0], azimuth=150, elevation=-30.0),
...
SUCCESS_FUNCTIONS = {
    ...
    "kettle": lambda element_pos, element_goal: np.linalg.norm(
        element_pos - element_goal
    )
    < 0.1,
