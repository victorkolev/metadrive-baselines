...
class Logger:
    def __init__(self, step, outputs, multiplier=1, prefix=None):
        self._step = step
    ...
    def scalar(self, name, value, prefix=None):
        self.add({name: value}, prefix=prefix)

    def image(self, name, value, prefix=None):
        self.add({name: value}, prefix=prefix)

    def video(self, name, value, prefix=None):
        self.add({name: value}, prefix=prefix)
